        ...
        >
          ...
          >
            ...
            >
              ...
              />
              <path
                d="M 60 140 Q 60 120 100 120 Q 140 120 140 140 L 140 160 Q 140 165 135 165 L 65 165 Q 60 165 60 160 Z"
                fill="none"
                stroke="var(--accent-color)"
                strokeWidth="2"
              />
              ...
              />
              <path
                d="M 140 162 L 140 178"
                stroke="var(--accent-color)"
                strokeWidth="2"
                strokeLinecap="round"
              />
              <path
                d="M 132 170 L 148 170"
                stroke="var(--accent-color)"
                strokeWidth="2"
                strokeLinecap="round"
              />
          ...
          >
            <div className="card-body auth-card-body">
              ...
              <p className="text-center text-muted mb-5">
                Log in to continue to Team Task Manager.
              </p>
